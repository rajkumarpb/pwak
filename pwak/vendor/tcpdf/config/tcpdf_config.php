...
if (!defined("K_TCPDF_EXTERNAL_CONFIG")) {
	 ...
	 * installation path
	 */
	define ("K_PATH_MAIN", "/home/bruno/ol/framework_unicode/vendor/tcpdf/");
	
	/**
	 * url path
	 */
	define ("K_PATH_URL", "http://localhost/ol_unicode/tcpdf/");
	 ...
	 * data font name
	 */
	define ("PDF_FONT_NAME_DATA", "vera"); //verase  /// vera
